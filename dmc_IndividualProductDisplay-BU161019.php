...
<div class="row-bs">
    <div class="col-xl-7 px-0 px-md-3">
        ...
        <div class="col-md-12 col-xl-5 px-0 px-md-3 py-4 py-xl-0 m-md-auto m-xl-0 d-flex flex-wrap">
            ...
            <div class="d-flex flex-wrap d-md-block align-items-end justify-content-center col-md-6 col-xl-12 <?php //echo $individualPage ? 5 : 4; ?> p-0 order-1 order-md-2 order-xl-2 py-3 py-md-0">
                <?php
                if ($individualPage) {
                    ...
                    echo '<div class="pl-0 pr-1 pt-xl-3 col-bs col-md-auto">ab</div>';
                        ...
                        <div class="row-bs">
                            <div class="col-bs">
                                <div id="gbu0--prodaddtocart--<?php print $id; ?>--itemquantity--d" class="khxc_formtbldiv">
                                    <div id="gbu0--prodaddtocart--<?php print $id; ?>--itemquantity" class="khxc_formtblone">
                                        <fieldset>
                                            <input class="prod-input font-16 font-md-14" type="number" name="gbu0--prodaddtocart--<?php print $id; ?>--quantity" id="gbu0--prodaddtocart--<?php print $id; ?>--quantity" value="1" size="5" maxlength="5">
                                        </fieldset>
                                    </div>
                                </div>
                            </div>
                            <div class="col-bs">
                                <div class="m-auto col-bs p-0">
                                    <input class="button button--green-blue text-center py-2 font-14" type="submit" name="SUBMIT" id="gbu0--prodaddtocart--<?php print $id; ?>--SUBMIT" value="In den Warenkorb" onclick="return DisableSubmit('gbu0--prodaddtocart--<?php print $id; ?>');" onkeypress="return DisableSubmit('gbu0--prodaddtocart--<?php print $id; ?>');">
                                </div>
                            </div>
                        </div>
                    </form>
