...
<div class="py-2 font-12 d-flex flex-wrap align-items-center">
        ...
        <div class="underline"><a href="/bespoke-custom-worktops">Bespoke Kitchen Worktops</a></div>
        <div class="arrow arrow--right mx-2"></div>
        <div>Online Bespoke Worktop Tool</div>
    </div>
    ...
    <div class="row-bs background-green colour-white pt-md-4 my-3">
        <div class="col-md-6 d-flex flex-wrap flex-column-reverse flex-md-row px-3 order-2 order-md-1">
            ...
            <div class="text-center text-md-left py-3">
                <a class="button button--white colour-green font-14 font-md-18 px-md-4 py-md-3" href="https://bespokeworktoptool3.worktop-express.co.uk/choose/" target="_blank">Start Designing Your Worktop</a>
            </div>
        </div>
    ...
    <div class="col-md">
            ...
            <div class="row-bs py-2">
                ...
                <div class="col-md font-md-18 px-3 pl-md-0">
                    <div class="font-weight-6">Our team issue a fabrication diagram</div>
            ...
            <div class="row-bs py-2">
                ...
                <div class="col-md font-md-18 px-3 pl-md-0">
                    <div class="font-weight-6">Your order is created and delivered (3-8 days)</div>
                    <div>Our experts fabricate your worktops to your specification</div>
                </div>
            </div>
            
            <div class="row-bs pt-2 pb-4">
                <a class="offset-md-2 pl-3 p-md-0 underline colour-green font-18" href="https://bespokeworktoptool3.worktop-express.co.uk/choose/">Start Designing Your Worktop</a>
            </div>
        </div>
        
        <div class="d-flex d-md-none pb-2">
            <div class="col-6 px-0 pr-1">
                <img class="w-100 lazyload" data-srcset="/media/categories/bespoke/wood/fabrication-team-cad-machine--mob.jpg 1x, /media/categories/bespoke/wood/fabrication-team-cad-machine--mob@2x.jpg 2x" alt="Fabrication team member working with our CAD machine">
            </div>
            <div class="col-6 px-0 pl-1">
                <img class="w-100 lazyload" data-srcset="/media/categories/bespoke/wood/fabrication-team-sanding--mob.jpg 1x, /media/categories/bespoke/wood/fabrication-team-sanding--mob@2x.jpg 2x" alt="Fabrication team member sanding an oak worktop">
            </div>
        </div>
        ...
        <div class="col-xl-5 align-self-start py-3 px-md-4 background-grey5 colour-white ml-xl-2">
            ...
            <div class="py-3">
                ...
                <div>
                    <a class="secretJS font-md-20 underline"></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row-bs d-none d-md-flex py-2">
        <div class="col-6 px-0 pr-1">
            <img class="w-100 lazyload" data-srcset="/media/categories/bespoke/wood/fabrication-team-cad-machine.jpg 1x, /media/categories/bespoke/wood/fabrication-team-cad-machine@2x.jpg 2x" alt="Fabrication team member working with our CAD machine">
        </div>
        <div class="col-6 px-0 pl-1">
            <img class="w-100 lazyload" data-srcset="/media/categories/bespoke/wood/fabrication-team-sanding.jpg 1x, /media/categories/bespoke/wood/fabrication-team-sanding@2x.jpg 2x" alt="Fabrication team member sanding an oak worktop">
        </div>
    </div>
    
    <div class="row-bs d-block p-3 background-grey"><span class="font-weight-5">Please note:</span> the 10% discount applies only to orders placed via the online tool (offer excludes orders placed via any other medium - such as email or telephone). Any discounts which apply to the worktops will have already been applied, therefore no further discount will be displayed at the checkout.</div>
...
<!--Related catagories END-->
    ...
    <div class="text-center pt-5">
        ...
        <a href="https://bespokeworktoptool3.worktop-express.co.uk/choose/" class="button button--green font-18 p-3 m-3">Bespoke Worktop Tool</a>
    </div>
