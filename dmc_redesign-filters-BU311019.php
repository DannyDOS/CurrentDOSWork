<style>
    ...
    <div class="row-bs">
            <div class="col-bs pr-2 font-16 font-md-12">
                ...
                <p class="d-none d-md-block mb-0">Laminate kitchen work surfaces are a low-maintenance worktop choice, and are both highly durable and easy to clean. Transform your home for less with laminate countertops from Worktop ExpressÃ�ï¿½Ã¯Â¿Â½Ã�ï¿½Ã�Â®, one of the UK's leading online worktop retailers.</p>
            </div>
            <div class="col-4-bs d-none d-xl-block">
    ...
    <a href="/bathroom-worktops">
        <div class="d-flex flex-wrap">
            ...
            <img src="/media/gbu0/bathroom-worktops-promo.jpg" alt="Oak bathroom worktop" class="col-md-7 col-xl-auto p-0">
        </div>
    </a>
