    ...
    <div class="row-bs py-2">
        <div class="col-xl-6" id="more-details">
            ...
            <div class="collapse shadow my-3">
                ...
                <div class="collapse__wrap">
                    <p class="p-3 m-0">Alle Tischplatten werden mit dem Lieferservice GLS bis zu Ihrer Haustür ausgeliefert. Die Lieferung erfolgt versandkostenfrei. Für mehr Informationen lesen Sie bitte unsere <a href="/lieferdetails.html">Lieferdetails</a>.</p>
                </div>
            </div>
...
//         case 'tischplatten-wood':
//             $image = '/media/gallery/massivholz-arbeitsplatten-muster.jpg';
//             $content = 'tischplatten-wood tischplatten-wood tischplatten-wood tischplatten-wood.';
...
//             break;
//         case 'tischplatten-laminate':
//             $image = '/media/gallery/arbeitsplatten-aus-laminat.jpg';
//             $content = 'tischplatten-laminate tischplatten-laminate tischplatten-laminate tischplatten-laminate.';
