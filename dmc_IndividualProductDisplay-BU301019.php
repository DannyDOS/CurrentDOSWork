    ...
    <div class="col-xl-7 px-0 px-md-3">
        ...
        <div class="col-md-12 col-xl-5 px-xl-0 py-4 py-xl-0 m-md-auto m-xl-0 d-flex flex-wrap">
            ...
            <div class="text-md-center text-xl-left order-4 order-xl-1">
                ...
                //$individualPage = true;
                $fullSize = $proddisp['enhanced_ecommerce_variant'];
                $individualPage = !empty($fullSize);
                ?>
            ...
            <div class="collapse shadow my-3 d-xl-none">
                ...
                <div class="collapse__wrap">
                    <div class="p-3">
                        ...
                        <!-- laminate code with wood injections   -->

                        <div class="py-3">
                            <div class="underline">L&auml;nge/n:</div>
                            <div>
                                ...
                                <?php
                                    ...
                                    if ($data->category === 'wood' && (stripos($data->name, 'eiche') !== false || stripos($data->name, 'buche') !== false)) {
                                        echo '(<a class="inline-link" href="/fabrikationsservice-holzarbeitsplatten-nach-mass" target="_blank">kundenspezifische L&auml;ngen</a> sind ebenfalls m&ouml;glich)';
                                    }
                                ?>
                        ...
                        <div class="py-3">
                            <div class="underline">St&auml;rke/n:</div>
                            <div>
                            <?php
                                if (count($data->spec->thicknesses) > 1) {
                                    foreach ($data->spec->thicknesses as $key => $item) {
                                        echo $item;
                                        echo $key !== count($data->spec->thicknesses) - 1 ? ', ' : ' ';
                                    }
                                } else {
                        ...
                        <!-- end of laminate code with wood injections   -->
                    </div>                       
                </div>
            </div>
...
?>
    ...
    <div class="row-bs py-5 px-3">
        ...
        <div class="col-md-7 col-xl">
            ...
            <p class="my-4">Falls Sie eine andere L&auml;nge oder Breite als gelistet ben&ouml;tigen, bieten wir alternativ einen <a href="<?php echo $bespokeLink; ?>">Zuschnitt-Service</a> f&uuml;r unsere Arbeitsplatten, welche aus demselben hochwertigen Holz bestehen wie auch diese Tischplatten, an.</p>
...
?>
    ...
    <!--Related catagories-->
    <div class="uppercase font-26 py-4">&Auml;hnliche Kategorien</div>
    <?php
